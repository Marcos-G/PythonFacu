            ...
            for o in range(20):
                ...
                for k in range(20):
                    if(j==0):
                        ...
                        if(np.array_equal(getColor(outp,2,o,k),getColor(outp,3,i-1,j)) and np.array_equal(getColor(outp,1,o,k),getColor(outp,3,i-1,j-1)) and np.array_equal(getColor(outp,2,o,k),getColor(outp,3,i,j-1))):
                            moverPieza(outp,o,k,i,j)
                            cortar=True
                            break
