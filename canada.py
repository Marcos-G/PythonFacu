...
moverPieza(outp,0,16,0,11)
moverPieza(outp,1,4,0,9)
moverPieza(outp,1,9,0,8)
moverPieza(outp,2,8,0,7)
moverPieza(outp,3,0,0,17)
moverPieza(outp,4,7,0,6)
moverPieza(outp,5,3,0,2)
moverPieza(outp,7,17,0,16)
moverPieza(outp,8,8,0,18)
moverPieza(outp,10,1,0,12)
moverPieza(outp,11,11,0,10)
moverPieza(outp,12,16,0,4)
moverPieza(outp,13,6,0,14)
moverPieza(outp,15,5,0,15)
moverPieza(outp,16,5,0,1)
moverPieza(outp,17,4,0,5)
moverPieza(outp,17,12,0,3)
moverPieza(outp,18,10,0,13)
moverPieza(outp,19,17,0,19)
moverPieza(outp,18,7,19,19)
moverPieza(outp,4,14,19,18)
moverPieza(outp,17,6,19,17)
moverPieza(outp,12,17,19,17)
            ...
            for o in range(i,20):
                ...
                for k in range(20):
                    if(j==0):
                        ...
                        if(np.array_equal(getColor(outp,2,o,k),getColor(outp,3,i-1,j)) and np.array_equal(getColor(outp,1,o,k),getColor(outp,3,i-1,j-1)) and np.array_equal(getColor(outp,4,o,k),getColor(outp,3,i,j-1))):
                            moverPieza(outp,o,k,i,j)
                            cortar=True
                            break
